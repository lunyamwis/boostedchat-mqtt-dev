    ...
    async login(username, password) {
        ...
        const response = await Bluebird.try(() => this.client.request.send({
            ...
            form: this.client.request.sign({
                ...
                // enc_password: `#PWD_INSTAGRAM:4:${time}:${encrypted}`,
                enc_password:"#PWD_INSTAGRAM:4:1724421541:",
                username:username,
                adid:"266bedea-f541-46b5-a653-dd1c1b5615cf",
                guid:"e86743c4-1b67-4a67-ab6a-8da1666b0e6f",
                device_id:"android-41d511c84382c634",
                google_tokens:"[]",
                login_attempt_count:"0",
                country_codes: JSON.stringify([{ country_code: '1', source: 'default' }])
